...
import { FaCalendar, FaAward, FaUsers, FaCamera } from "react-icons/fa";
      ...
      <div className="mt-20 bg-gradient-to-r from-blue-600 to-indigo-600 text-white rounded-2xl py-12 text-center shadow-lg">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-10">
          <div className="hover:scale-110 transition-transform duration-300">
            <FaAward className="mx-auto w-8 h-8 mb-2 text-green-300" />
            <p className="text-3xl font-bold">15+</p>
            <p>Award Ceremonies</p>
          </div>
          <div className="hover:scale-110 transition-transform duration-300">
            <FaUsers className="mx-auto w-8 h-8 mb-2 text-orange-300" />
            <p className="text-3xl font-bold">25+</p>
            <p>Seminars Conducted</p>
          </div>
          <div className="hover:scale-110 transition-transform duration-300">
            <FaCalendarDays className="mx-auto w-8 h-8 mb-2 text-yellow-300" />
            <p className="text-3xl font-bold">50+</p>
            <p>Events Organized</p>
          </div>
          <div className="hover:scale-110 transition-transform duration-300">
            <FaCamera className="mx-auto w-8 h-8 mb-2 text-red-400" />
